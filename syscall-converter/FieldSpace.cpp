 ...
 * 
 * This file implements all the functions in FieldSpace.hpp.
 * The description of this class can be found in its header file.
 */
...
void FieldSpace::addFields(const string &syscallName, ExtentSeries &series) {
  ...
  for (uint32_t i = 0; i < extenttype->getNFields(); i++) {
    ...
    case ExtentType::ft_bool :
      addField(syscallName, fieldName, new BoolField(series, fieldName, nullable),
	       ExtentType::ft_bool);
      break;
    case ExtentType::ft_byte :
      addField(syscallName, fieldName, new ByteField(series, fieldName, nullable),
	       ExtentType::ft_byte);
      break;
    case ExtentType::ft_int32 :
      addField(syscallName, fieldName, new Int32Field(series, fieldName, nullable),
	       ExtentType::ft_int32);
      break;
    case ExtentType::ft_int64 :
      addField(syscallName, fieldName, new Int64Field(series, fieldName, nullable),
	       ExtentType::ft_int64);
      break;
    case ExtentType::ft_double :
      addField(syscallName, fieldName, new DoubleField(series, fieldName, nullable),
	       ExtentType::ft_double);
      break;
    case ExtentType::ft_variable32 :
      addField(syscallName, fieldName, new Variable32Field(series, fieldName, nullable),
