 ...
 *
 * FieldSpace stores all fields that are going to be written to
 * DataSeries output file. It supports adding, getting,
 * and setting fields.
 */

#ifndef FIELD_SPACE_HPP
#define FIELD_SPACE_HPP
